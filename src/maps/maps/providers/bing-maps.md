...
You can enable this feature by setting [`LayerType`](https://help.syncfusion.com/cr/aspnetcore-blazor/Syncfusion.Blazor~Syncfusion.Blazor.Maps.ShapeLayerType.html) to “ShapeLayerType.Bing”.
...
To render the light version of the road maps, set the [`BingMapType`](https://help.syncfusion.com/cr/aspnetcore-blazor/Syncfusion.Blazor~Syncfusion.Blazor.Maps.MapsLayer~BingMapType.html) to [`CanvasLight`](https://help.syncfusion.com/cr/aspnetcore-blazor/Syncfusion.Blazor~Syncfusion.Blazor.Maps.BingMapType.html) as demonstrated in the following code sample.
