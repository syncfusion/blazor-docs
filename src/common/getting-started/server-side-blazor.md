...
## Create a new Blazor Server project in Visual Studio 2019
...
5. Choose **Blazor Server App** from the dashboard and click the **Create** button to create a new Blazor Server application. 
