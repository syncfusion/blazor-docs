...
* The [`DataSource`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Diagrams.DiagramDataSource~DataSource.html ) property is used to define the data source either as a collection of objects or as an instance of [`DataSource`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Diagrams.DiagramDataSource~DataSource.html ) that needs to be populated in the diagram.
...
* To explore those properties, see [`DataSourceSettings`](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Diagrams.SfDiagram~DataSourceSettings.html).
...
To map the user defined JSON data with diagram, configure the fields of [`DataSourceSettings`](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Diagrams.SfDiagram~DataSourceSettings.html). The following code example illustrates how to bind local data with the diagram.
