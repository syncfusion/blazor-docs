...
<button @onclick="UpdateScheduleDate">Change Schedule Dates</button>
...
@code{
    ...
    {
    this.Gantt.UpdateProjectDates(new DateTime(2019, 01, 10), new DateTime(2019, 06, 20), true);
    }
...
![Alt text](../images/updatescheduledates.gif)
