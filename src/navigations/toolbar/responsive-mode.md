...
`OverflowMode` as `MultiRow` provides supports to display the overflowing toolbar items as an in-line of Toolbar.

The following code explains how to define `MultiRow` mode in the Toolbar.

```csharp
@using Syncfusion.Blazor.Navigations

<SfToolbar Width="600px" OverflowMode="@OverflowMode.MultiRow">
    <ToolbarItems>
        <ToolbarItem PrefixIcon="e-cut-icon tb-icons" Text="Cut"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-copy-icon tb-icons" Text="Copy"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-paste-icon tb-icons" Text="Paste"></ToolbarItem>
        <ToolbarItem Type="@ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-bold-icon tb-icons" Text="Bold"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-underline-icon tb-icons" Text="Underline"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-italic-icon tb-icons" Text="Italic"></ToolbarItem>
        <ToolbarItem Type="@ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-bullets-icon tb-icons" Text="Bullets"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-undo-icon tb-icons" Text="Undo"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-redo-icon tb-icons" Text="Redo"></ToolbarItem>
        <ToolbarItem Type="@ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-alignleft-icon tb-icons" Text="Left"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-alignright-icon tb-icons" Text="Right"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-aligncenter-icon tb-icons" Text="Center"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-alignjustify-icon tb-icons" Text="Justify"></ToolbarItem>
    </ToolbarItems>
</SfToolbar>
...
![Toolbar with MultiRow OverflowMode](./images/MultiRow.png)

## Extended

`Extended` is one of the type of `OverflowMode` which hide the overflowing toolbar items in the next row. The overflowing toolbar items shown when you click the expand icons. If the popup content overflows the height of the page, the rest of the elements will be hidden.

The following example shows how to define `Extended` type of `OverfloMode`.

```csharp
@using Syncfusion.Blazor.Navigations

<SfToolbar Width="600px" OverflowMode="@OverflowMode.Extended">
    <ToolbarItems>
        <ToolbarItem PrefixIcon="e-cut-icon tb-icons" Text="Cut"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-copy-icon tb-icons" Text="Copy"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-paste-icon tb-icons" Text="Paste"></ToolbarItem>
...
![Toolbar Control with Extended Type](./images/Extended.png)
