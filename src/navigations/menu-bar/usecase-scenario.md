...
The following example demonstrates the use case of [`HamburgerMenu`](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Navigations.SfMenu.html#Syncfusion_Blazor_Navigations_SfMenu_HamburgerMode) mode.
