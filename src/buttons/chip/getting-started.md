...
This section briefly explains how to include a `Chip` in your Blazor Server-Side application. Refer to the [Getting Started with Syncfusion Blazor for Server-Side in Visual Studio 2019 page](https://blazor.syncfusion.com/documentation/getting-started/server-side-blazor/) for the introduction and configuring the common specifications.
...
* Install **Syncfusion.Blazor.Buttons** NuGet package to the application by using the `NuGet Package Manager`.
