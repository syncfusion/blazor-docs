...
[`Loaded`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~Loaded.html) event triggers after stock chart is rendered.
...
[`OnPointClick`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~OnPointClick.html) event triggers when data point is clicked.
...
[`PointMoved`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~PointMoved.html) event triggers when moving mouse over the data point.
...
[`RangeChange`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~RangeChange.html) event triggers when range is changed.
...
[`OnStockChartMouseClick`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~OnStockChartMouseClick.html) event triggers when clicking the stock chart.
...
[`OnStockChartMouseDown`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~OnStockChartMouseDown.html) event triggers when mouse down over the stock chart.
...
[`OnStockChartMouseLeave`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~OnStockChartMouseLeave.html) event triggers when cursor leaves the stock chart.
...
[`OnStockChartMouseMove`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~OnStockChartMouseMove.html) event triggers when hovering the stock chart.
...
[`OnStockChartMouseUp`](https://help.syncfusion.com/cr/cref_files/blazor/Syncfusion.Blazor~Syncfusion.Blazor.Charts.StockChartEvents~OnStockChartMouseUp.html) event triggers when mouse is up.
