...
| Kanban_Min | Min |
| Kanban_Max | Max |
| Kanban_CardsSelected | Cards Selected |
| Kanban_AddTitle | Add New Card |
| Kanban_EditTitle | Edit Card Details |
| Kanban_DeleteTitle | Delete Card |
| Kanban_DeleteContent | Are you sure you want to delete this card? |
| Kanban_Save | Save |
