...
<SfToolbar Width="600" ScrollStep="50">
    <ToolbarItems>
        ...
        <ToolbarItem PrefixIcon="e-copy-icon tb-icons" Tooltiptext="Copy"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-paste-icon tb-icons" Tooltiptext="Paste"></ToolbarItem>
        <ToolbarItem Type="ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-bold-icon tb-icons" Tooltiptext="Bold"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-underline-icon tb-icons" Tooltiptext="Underline"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-italic-icon tb-icons" Tooltiptext="Italic"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-color-icon tb-icons" Tooltiptext="Color-Picker"></ToolbarItem>
        <ToolbarItem Type="ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-alignleft-icon tb-icons" Tooltiptext="Align-Left"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-alignright-icon tb-icons" Tooltiptext="Align-Right"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-aligncenter-icon tb-icons" Tooltiptext="Align-Center"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-alignjustify-icon tb-icons" Tooltiptext="Align-Justify"></ToolbarItem>
        <ToolbarItem Type="ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-bullets-icon tb-icons" Tooltiptext="Bullets"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-numbering-icon tb-icons" Tooltiptext="Numbering"></ToolbarItem>
        <ToolbarItem Type="ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-ascending-icon tb-icons" Tooltiptext="Sort A - Z"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-descending-icon tb-icons" Tooltiptext="Sort Z - A"></ToolbarItem>
        <ToolbarItem Type="ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-upload-icon tb-icons" Tooltiptext="Upload"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-download-icon tb-icons" Tooltiptext="Download"></ToolbarItem>
        <ToolbarItem Type="ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-indent-icon tb-icons" Tooltiptext="Text Indent"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-outdent-icon tb-icons" Tooltiptext="Text Outdent"></ToolbarItem>
        <ToolbarItem Type="ItemType.Separator"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-clear-icon tb-icons" Tooltiptext="Clear"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-reload-icon tb-icons" Tooltiptext="Reload"></ToolbarItem>
        <ToolbarItem PrefixIcon="e-export-icon tb-icons" Tooltiptext="Export"></ToolbarItem>
    </ToolbarItems>
</SfToolbar>
