...
SplitButton component can be enabled or disabled by disabled property. To disable SplitButton component, set the [`disabled`](https://help.syncfusion.com/cr/cref_files/aspnetcore-blazor/Syncfusion.EJ2.RazorComponents~Syncfusion.EJ2.RazorComponents.SplitButtons.EjsSplitButton~Disabled.html) property as true.
...
<EjsSplitButton ID="element" Content="Paste" Items="@items" IconCss="e-sb-icons e-paste" Disabled=true></EjsSplitButton>
