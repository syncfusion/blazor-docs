...
Set the desired [`Tool`](https://help.syncfusion.com/cr/aspnetcore-blazor/Syncfusion.Blazor~Syncfusion.Blazor.Diagrams.IDiagram~Tool.html) to the tool property of the diagram model.
