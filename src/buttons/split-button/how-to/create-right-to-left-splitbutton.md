...
SplitButton component has RTL support. This can be achieved by setting [`enableRtl`](https://help.syncfusion.com/cr/cref_files/aspnetcore-blazor/Syncfusion.EJ2.RazorComponents~Syncfusion.EJ2.RazorComponents.SplitButtons.EjsSplitButton~EnableRtl.html) as `true`.
...
<EjsSplitButton ID="element" Content="Paste" Items="@items" IconCss="e-sb-icons e-paste" EnableRtl="true"></EjsSplitButton>
