# How to download Syncfusion Blazor Mac installer
...
5. For Mac OS, PKG formats is available for download.
   ...
   ![License Download Installer](images/blazor-mac.png)

You can also refer to the [Blazor Mac installation](https://blazor.syncfusion.com/documentation/installation/offline-installer/mac/how-to-install) link for step-by-step installation guidelines.