...
description: "This section helps to learn how to create the ProgressButton in ASP.NET Core Razor application with its basic features in step-by-step procedure."
---

<!-- markdownlint-disable MD024 -->

# Getting Started with Essential JS 2 for ASP.NET Core Razor ProgressButton Component in Visual Studio 2019

This article provides a step-by-step introduction to configure Essential JS 2 setup, build and publish a simple .NET Core Razor ProgressButton Component web application using the [Visual Studio 2019](https://visualstudio.microsoft.com/vs/preview/).
...
6. Now, add the Syncfusion Essential JS 2 ProgressButton component in any web page (cshtml) in the `Pages` folder. For example, the ProgressButton component is added in the **~/Pages/Index.cshtml** page.

    ```cshtml
    <EjsProgressButton ID="element" Content="Spin Left"></EjsProgressButton>
    ```

7. Run the application. The Essential JS 2 ProgressButton component will render in the web browser.
