...
component: "Checkbox"
description: "This section helps to learn how to create the Checkbox in Blazor application with its basic features in step-by-step procedure."
---
...
This section briefly explains about how to include Checkbox Component in your Blazor server-side  application. You can refer [Getting Started with Syncfusion Blazor for Server-side in Visual Studio 2019 page](https://blazor.syncfusion.com/documentation/getting-started/server-side-blazor/) page for the introduction and configuring the common specifications.
...
```csharp
<SfCheckBox Label="Default" Checked="true"></SfCheckBox>
```
